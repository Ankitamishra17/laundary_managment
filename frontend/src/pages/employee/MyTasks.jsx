          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs sm:text-sm text-[#6B8482] mt-0.5">
                Everything assigned to you for today.
              </p>
            </div>
          </div>
        </div>
                  ...
                  <tbody>
                    {tasks.map((t) => (
                      ...
                      >
                        ...
                        <td className="py-3.5 px-5 text-[#6B8482]">{formatTime(t.scheduled_time)}</td>
                        <td className="py-3.5 px-5">
                  ...
                  <div key={t.id} className="p-4 space-y-2.5">
                    ...
                    <div className="flex items-center justify-between pt-1">
                      <div className="text-xs text-[#6B8482]">
                        {TASK_TYPE_LABEL[t.task_type] || t.task_type} &middot; {formatTime(t.scheduled_time)}
                      </div>
                      <TaskAction
                        status={t.status}
                        onStart={() => updateStatus(t.id, "in_progress")}
