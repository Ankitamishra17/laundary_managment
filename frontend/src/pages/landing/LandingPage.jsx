                ...
                >
                  ...
                  >
                    ...
                    >
                      <ChevronDown
                        size={14}
                        color={isOpen ? "#FFFFFF" : colors.primaryTeal}
                      />
                    </span>
                  </button>
                  <div
...
const Eyebrow = ({ children, tone = "light" }) => (
  <span
    ...
    style={{
      backgroundColor:
        tone === "light" ? `${colors.mint}17` : `${colors.mint}22`,
...
function Navbar({ shop }) {
  ...
  return (
    ...
    >
      ...
      {menuOpen && (
        <div
          className="lg:hidden px-5 pb-6 pt-2 space-y-1"
          style={{ backgroundColor: colors.bgDark }}
        >
          {links.map((l) => (
            <a
      ...
      <div className="relative max-w-7xl mx-auto px-5 sm:px-8 pt-32 lg:pt-40 pb-20 lg:pb-28 grid lg:grid-cols-2 gap-16 lg:gap-10 items-center">
        <div>
          ...
          <motion.p
            ...
            style={{ color: "#A9C9C6" }}
          >
            {`Book online in under a minute at ${
              shop?.name || "our laundry"
            }. We pick up, wash, dry & fold your clothes with premium care — and
            deliver them back to your door, fresh and on time.`}

            {shop?.city && shop?.state && (
              <p className="mt-3 text-sm" style={{ color: "#A9C9C6" }}>
                Serving {shop.city}, {shop.state}
              </p>
            )}
          </motion.p>
        ...
        >
          ...
          <div
            ...
            style={{
              background:
                "linear-gradient(135deg, rgba(2,195,154,0.28), rgba(2,128,144,0.12))",
            }}
          />
          ...
          <div
            ...
            style={{
              background:
                "linear-gradient(135deg, rgba(2,195,154,0.55), rgba(2,128,144,0.22))",
            }}
          >
            <div className="rounded-[28px] overflow-hidden shadow-2xl">
              ...
              <div
                ...
                style={{
                  backgroundColor: "rgba(5,40,42,0.7)",
                  color: "#7EE8CC",
          ...
          >
            ...
            >
              <span>Picked up</span>
              <span className="font-bold" style={{ color: colors.seafoam }}>
                Washing
              </span>
              <span>Delivered</span>
            </div>
          ...
          <div
            ...
            style={{
              backgroundColor: "rgba(5,40,42,0.92)",
          ...
          >
            <div className="flex items-center gap-2.5">
              ...
              <div>
                ...
                <div className="text-[10px]" style={{ color: "#8FB3B0" }}>
                  ETA 2:30 PM · Free
                </div>
              </div>
            </div>
...
const services = [
  {
    icon: Droplets,
    name: "Wash & Fold",
    desc: "Machine wash, tumble dry and neatly folded. Perfect for everyday clothes.",
    price: "₹80",
    unit: "per kg",
  ...
  },
  {
    icon: Wind,
    name: "Wash & Iron",
    desc: "Washed and pressed to perfection — crisp lines on every shirt and trouser.",
    price: "₹99",
    unit: "per kg",
    color: colors.seafoam,
  },
  {
    icon: Sparkles,
    name: "Dry Cleaning",
    desc: "Gentle chemical cleaning for suits, silk, wool and delicate fabrics.",
    price: "₹149",
    unit: "per item",
    color: colors.mint,
  },
  {
    ...
    desc: "Professional steam pressing that removes every wrinkle and crease.",
    price: "₹25",
    unit: "per item",
    color: colors.primaryTeal,
  },
  {
    ...
    desc: "Comforters, curtains and towels washed large-scale with extra care.",
    price: "₹120",
    unit: "per item",
    color: colors.seafoam,
  },
  {
    icon: Crown,
    name: "Premium Care",
    desc: "Stain treatment, fabric softener and hand-finishing for special pieces.",
    price: "₹199",
    unit: "per item",
    color: colors.mint,
  },
...
const howSteps = [
  {
    icon: CreditCard,
    title: "Book online",
    desc: "Pick your services and a pickup slot — takes under a minute.",
  },
  {
    icon: Truck,
    title: "We pick up",
    desc: "Our rider collects your bag from your doorstep, right on schedule.",
  },
  {
    icon: Droplets,
    title: "Wash, dry & fold",
    desc: "Premium detergents, careful sorting and spotless finishing.",
  },
  {
    icon: Sparkles,
    title: "Delivered fresh",
    desc: "Back at your door, neatly packed and smelling amazing.",
  },
];
  ...
  return (
    ...
    >
      <div
        ...
        style={{ backgroundColor: `${colors.mint}14` }}
      />
      <div className="relative max-w-7xl mx-auto px-5 sm:px-8">
        ...
        <div className="relative">
          <div
            ...
            style={{
              backgroundImage: `linear-gradient(90deg, ${colors.primaryTeal} 0, ${colors.primaryTeal} 6px, transparent 6px, transparent 14px)`,
          ...
          <div
            ...
            style={{
              backgroundImage: `linear-gradient(180deg, ${colors.primaryTeal} 0, ${colors.primaryTeal} 6px, transparent 6px, transparent 14px)`,
            ...
            {howSteps.map((s, i) => (
              ...
              >
                <div className="md:flex md:flex-col md:items-start">
                  ...
                  <div
                    className="mt-0 md:mt-5 w-10 h-10 rounded-xl flex items-center justify-center"
...
function AppFeatures() {
  return (
    <section
      className="py-24 md:py-[120px] border-y"
      style={{
        ...
        <Reveal delay={120}>
          <div
            ...
            style={{
              ...
              boxShadow:
                "0 40px 80px -20px rgba(5,40,42,0.45), 0 0 0 1px rgba(2,128,144,0.15)",
            }}
          >
            <div className="bg-white rounded-[24px] overflow-hidden min-h-[440px] sm:min-h-[520px] px-4.5 py-5.5">
              ...
              >
                ...
                <div
                  className="h-[5px] rounded-md overflow-hidden mt-2"
                  style={{ backgroundColor: colors.cardTint }}
                >
                  <span
                    className="block h-full w-[64%] rounded-md"
                    style={{
                      background: `linear-gradient(90deg, ${colors.primaryTeal}, ${colors.mint})`,
                    }}
                  />
                </div>
...
const features = [
  {
    ...
    desc: "Not happy with a single piece? We redo it free. Simple as that.",
  },
  {
    icon: Clock,
    title: "Always on time",
    desc: "98.6% on-time delivery record, backed by live order tracking.",
  },
  {
    icon: Leaf,
    title: "Eco-friendly care",
    desc: "Skin-friendly, biodegradable detergents and energy-efficient machines.",
  },
  {
    icon: MapPin,
    title: "Doorstep service",
    desc: "Free pickup and delivery, every time — no minimum order.",
  },
  {
    icon: RefreshCw,
    title: "Live tracking",
    desc: "Follow your order from pickup to delivery on your dashboard.",
  },
  {
    icon: CreditCard,
    title: "Simple payments",
    desc: "Pay online or at delivery. Transparent pricing on every item.",
  },
];
            ...
            <Reveal delay={100}>
              <div className="mt-8 relative overflow-hidden rounded-2xl shadow-lg">
                ...
                <div
                  ...
                  style={{
                    background:
                      "linear-gradient(135deg, rgba(5,40,42,0.92), rgba(2,128,144,0.72))",
                  }}
                />
                <div className="absolute inset-0 flex items-center gap-5 p-6">
                  ...
                  >
                    "I haven't touched a washing machine in 14 months. WashFlow
                    just works."
                  </p>
                </div>
              </div>
...
const testimonials = [
  {
    ...
    text: "The pickup is always on time and my clothes smell incredible. The dashboard tracking is a game changer — I always know exactly where my order is.",
    rating: 5,
  },
  {
    name: "Rohit Mehta",
    ...
    text: "I'm a busy consultant who travels weekly. Same-day service means I always have crisp shirts for meetings. Worth every rupee.",
    rating: 5,
  },
  {
    name: "Priya Nair",
    ...
    text: "They handled my silk sarees with so much care. Dry cleaning results are flawless and delivery is always fresh and neatly packed.",
    rating: 5,
  },
];
  ...
  return (
    ...
    >
      <div
        ...
        style={{ backgroundColor: colors.panelDark, opacity: 0.6 }}
      />
      <div className="relative max-w-7xl mx-auto px-5 sm:px-8">
        <Reveal className="text-center max-w-2xl mx-auto mb-12 sm:mb-16">
              ...
              >
                ...
                <div className="mt-6 flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-xs" style={{ color: "#8FB3B0" }}>
                      {t.city}
                    </div>
                  </div>
                </div>
...
const plans = [
  {
    ...
    price: "₹199",
    period: "/month",
    desc: "For individuals who want the basics handled.",
    features: [
      "10 kg wash & fold / month",
  ...
  },
  {
    ...
    price: "₹399",
    period: "/month",
    desc: "The most-loved plan for busy households.",
    features: [
      "25 kg wash & fold / month",
      "Priority same-day pickup",
      "24-hour turnaround",
  ...
  },
  {
    ...
    price: "₹699",
    period: "/month",
    desc: "For those who want everything, unlimited.",
    features: [
      "Up to 50 kg / month",
      "Dedicated service manager",
      "Same-day express service",
      "Premium fabric care",
      "Free dry cleaning (2 items)",
    ],
    popular: false,
  },
];
          ...
          {plans.map((p, i) => (
            <Reveal key={p.name} delay={i * 100}>
              <TagCard
                ...
                style={
                  p.popular
                    ? { boxShadow: "0 24px 60px rgba(5,40,42,0.28)" }
                    : {}
                }
              >
                {p.popular && (
                ...
                <h3
                  ...
                  style={{ color: p.popular ? "#FFFFFF" : colors.textDark }}
                >
                  {p.name}
                </h3>
                <p
                  className="mt-1.5 text-xs leading-relaxed"
                  style={{ color: p.popular ? "#8FB3B0" : colors.textMuted }}
                >
                  {p.desc}
                </p>
                <div className="mt-5 flex items-baseline gap-1">
                  <span
                    ...
                    style={{
                      color: p.popular ? colors.mint : colors.textDark,
                      fontFamily: "'Libre Baskerville', serif",
                    }}
                  >
                    {p.price}
                ...
                <ul className="mt-6 space-y-3 flex-1">
                  {p.features.map((f) => (
                    <li key={f} className="flex items-start gap-2.5 text-sm">
                      ...
                      <span
                        style={{
                          color: p.popular ? "#C8E3E0" : colors.textDark,
                        }}
                      >
                        {f}
                      </span>
...
// CTA BANNER
// ------------------------------------------------------------
function CtaBanner({ shop }) {
  const { user } = useAuth();
  const { slug } = useParams();

  const shopName = shop?.name || "your laundry";

  return (
    <section
      className="px-5 sm:px-8 pb-20 sm:pb-28"
      style={{ backgroundColor: colors.bgLight }}
    >
      <div className="max-w-7xl mx-auto">
        <Reveal>
          <div
            ...
            style={{
              background:
                "linear-gradient(120deg, #05282A, #0B3B3E 55%, #028090)",
            }}
          >
            ...
            <div
              ...
              style={{ backgroundColor: `${colors.primaryTeal}33` }}
            />
            ...
            <div className="relative">
              ...
              >
                ...
                <br />
                fresh laundry at {shopName}?
              </h2>

              {/* Description */}
              <p
                className="mt-5 text-sm sm:text-base max-w-md mx-auto leading-relaxed"
                style={{ color: "#A9C9C6" }}
              >
                Create your free account in 30 seconds and schedule your first
                pickup at {shopName} today.
              </p>
    ...
    <footer style={{ backgroundColor: colors.bgDark }}>
      <div className="max-w-7xl mx-auto px-5 sm:px-8 py-14 grid sm:grid-cols-2 lg:grid-cols-4 gap-10">
        <div>
          ...
          >
            {shop?.name
              ? `${shop.name} provides quality laundry pickup and delivery services. Fresh clothes, zero effort.`
              : "Premium laundry pickup & delivery, powered by trusted local laundries. Fresh clothes, zero effort."}
          </p>
        </div>
        ...
        <div>
          ...
          <ul className="mt-4 space-y-3 text-sm" style={{ color: "#A9C9C6" }}>
            <li className="flex items-center gap-2.5">
              <PhoneCall size={15} color={colors.mint} />
              {shop?.phone || "Contact number unavailable"}
            </li>
            <li className="flex items-center gap-2.5">
              <Mail size={15} color={colors.mint} />
              {shop?.email || "Email unavailable"}
            </li>
            <li className="flex items-start gap-2.5">
              <MapPin size={15} color={colors.mint} className="mt-0.5" />{" "}
      ...
      <div
        className="border-t"
        style={{ borderColor: `${colors.primaryTeal}33` }}
      >
        <div className="max-w-7xl mx-auto px-5 sm:px-8 py-5 flex flex-col sm:flex-row items-center justify-between gap-3">
          <span className="text-xs" style={{ color: "#8FB3B0" }}>
            © {new Date().getFullYear()} {shop?.name || "WashFlow"}. All rights
            reserved.
          </span>

          <span className="text-xs" style={{ color: "#8FB3B0" }}>
            Made with <span style={{ color: colors.mint }}>♥</span> for cleaner
            wardrobes
          </span>
        </div>
      </div>
