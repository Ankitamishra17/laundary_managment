...
export default function ShopDashboard() {
  ...
  const stats = [
    ...
    },
    {
      ...
      delta: dashboard?.summary?.todayRevenue ? `+${formatINR(dashboard.summary.todayRevenue)} today` : `${orders.length} orders`,
      icon: IndianRupee,
      color: colors.mint,
    },
    {
      ...
      delta: dashboard?.customers?.newToday ? `+${dashboard.customers.newToday} today` : `${customers.filter((c) => c.city).length} with city`,
      icon: Users,
