...
export const taskApi = {
  ...
  getOrderTasks: (orderId) =>
    api.get(`/tasks/order/${orderId}`).then((r) => r.data.data),
  // REASSIGN TASK
  // ------------------------------------------------------------
  //
  // force = false
  ...
  //
  // force = true
  //   → admin clicked "Assign Anyway"
  //
  reassignTask: (taskId, employee_id, force = false) =>
    api
  ...
  // Employee
  getMyTasks: (params) =>
    api.get("/tasks/my-tasks", { params }).then((r) => r.data.data),
  getMyTaskStats: (params) =>
    api.get("/tasks/my-tasks/stats", { params }).then((r) => r.data.data),
  ...
  getMyCustomerTasks: () =>
    api.get("/tasks/my-customer-tasks").then((r) => r.data.data),
};
