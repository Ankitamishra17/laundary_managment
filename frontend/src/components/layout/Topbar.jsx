...
function getNotificationLink(notification, role, slug) {
  ...
  // -----------------------------------------------
  // Admin shop-based routes
  // -----------------------------------------------

  if (role === "admin" && slug && rawLink.startsWith("/admin/")) {
    return `/${slug}${rawLink}`;
  }
                      ...
                      <div>
                        ...
                        >
                          {isSuperAdmin
                            ...
                            : isAdmin
                              ? "Orders, inventory and subscription alerts"
                              : isCustomer
                                ? "Order delivery alerts"
                                : "Task and other alerts"}
                        </p>
                      </div>
                          ...
                          >
                            <div className="flex gap-3">
                              ...
                              <div className="min-w-0 flex-1">
                                          ...
                                          notification.daysRemaining !==
                                            ...
                                            >
                                              {notification.daysRemaining === 0
                                                ? "Expires today"
                                                : `${notification.daysRemaining} day${
                                                    notification.daysRemaining ===
                                                    1
                                                      ? ""
                                                      : "s"
                                ...
                                {!isSuperAdmin && kind !== "subscription" && (
                                  <p
